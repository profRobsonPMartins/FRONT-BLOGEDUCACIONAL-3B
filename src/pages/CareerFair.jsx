...
import imgCarrerFair from '../components/img/feira-profissoes-unisepe.svg';
...
const CareerFair = () => {
  return (
    <div className="blog-detail">
      ...
      <img src={imgCarrerFair} alt="Feira de Profissões na UNISEPE" className="detail-image" />
